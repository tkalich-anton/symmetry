...
\lhead{Вся арифметика} \rhead{Школа <<Симметрия>>}
\section{Числа на прямой}
	\subsection{Дроби на числовой прямой}
	\subimport{coordinate_line/fractions}{coordinate_line_fractions}
	\subsection{Корни на числовой прямой}
	\subimport{coordinate_line/roots}{coordinate_line_roots}
	\subsection{Сравнение чисел на числовой прямой}
	\subimport{coordinate_line/comparison}{coordinate_line_comparison}
\section{Дроби}
