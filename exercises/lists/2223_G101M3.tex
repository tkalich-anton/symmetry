...
\begin{listofex}
	...
	\begin{enumcols}[itemcolumns=4]
		...
		\item \( \dfrac{21^{13}}{7^{15}\cdot3^{12}} \)
	...
	\item В треугольнике \(ABC\) \(AС=BC\), \(AB=9,6\), \(\sin A =\dfrac{7}{25}\). Найдите AC.
\end{listofex}
%
%===============>>  Занятие 7  <<===============
%
...
\begin{listofex}
	...
	\item Вычислить:
	\begin{enumcols}[itemcolumns=2]
		\item \( \dfrac{100^8}{2^{15}\cdot 5^{14}} \)
		\item \( \dfrac{2^{14}\cdot 3^{11}}{72^{6}} \)
	\end{enumcols}
