...
\begin{listofex}
	\item Вычислить значения синуса и косинуса \( 30\degree \), \( 45\degree \), \( 60\degree \), а также \( 0\degree \) и \( 90\degree \)
	\item Вычислить значения тангенса и котангенса с теми же самыми аргументами.
	\item Доказать следующие факты:
	\begin{enumcols}
		\item Основное тригонометрическое тождество (ОТТ): \( \sin^2x+\cos^2x=1 \)
		\item \( \tg x = \dfrac{\sin x}{\cos x} \), \( \ctg x = \dfrac{\cos x}{\sin x} \) и \( \tg x \cdot \ctg x = 1 \)
	\end{enumcols}
	\fbox{%
