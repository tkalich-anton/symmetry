...
%	\begin{listofex}
%		\item Начертите в тетради:
%		\begin{tasks}(1)
%			\task 3 разных острых угла;
%			\task 3 разных тупых угла;
%			\task прямой угол;
%			\task развёрнутый угол;
%		\end{tasks}
%		\item Начертите в тетради:
%		\begin{tasks}
%			\task угол, градусная величина которого равна \( 80\degree \);
%			\task угол, градусная величина которого равна \( 185\degree \).
%		\end{tasks}
%		\item Какой угол образуют часовая и минутная стрелка:
%		\begin{tasks}(3)
%			\task в 3 часа утра;
%			\task в 20 часов вечера;
