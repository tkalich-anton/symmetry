...
\begin{listofex}
	...
	этого же дома?
	\item Найти значение буквенного выражения \( (a-b)\cdot(b+c) \), если \( a=247;\; b=189;\; c=127 \).
	\item Найти значение буквенного выражения \( a^2+2\cdot a\cdot b + b^2 \), если \( a=217 \) и \( b=83 \).
	...
	\item На машину погрузили \( a \) одинаковых (по массе) ящиков с деталями и станок. Общая масса
...
\begin{listofex}
	\item Вычислить: \( (24\cdot7-377:29)\cdot(2378:58-38) \)
	\item С книжного склада отправили в пять школ города \( 28\:800 \) учебников. В первую школу отправили четвёртую часть всех учебников, во вторую --- \( 6\:300 \) учебников, а остальные учебники были отправлены в последние три школы, поровну в каждую. Сколько учебников получила каждая из школ?
	\item Лёва купил несколько килограммов черешни по цене \( 250 \) рублей за кг, а Яша --- \( 3 \) кг
	клубники по цене \( 100 \) рублей за кг. Всего они заплатили \( 1550 \) рублей. Сколько килограммов
	черешни купил Лёва?
	\item Лёва купил несколько килограммов черешни по цене \( a \) рублей за кг, а
