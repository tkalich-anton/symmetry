...
\begin{class}[number=6]
	\begin{listofex}
		...
		\begin{minipage}[t]{\picwidth}
			\includegraphics[align=t, width=\linewidth]{\picpath/G101M4C4-1}
		\end{minipage}
		\item
		\begin{minipage}[t]{\bodywidth}
		...
		\hspace{0.02\linewidth}
		\begin{minipage}[t]{\picwidth}
			\includegraphics[align=t, width=\linewidth]{\picpath/G101M4H2-5}
		\end{minipage}
		\item
		\begin{minipage}[t]{\bodywidth}
...
%		\end{minipage}
		...
		\hspace{0.02\linewidth}
		\begin{minipage}[t]{\picwidth}
			\includegraphics[align=t, width=\linewidth]{\picpath/G101M4C6-5}
		\end{minipage}
%		\item
%		\begin{minipage}[t]{\bodywidth}
%			На рисунке изображён график функции вида \[ f(x)=\dfrac{ax+b}{x+c}, \] где числа \(a, b, c\) --- целые. Найдите \(b\).
...
\begin{exam}
	\begin{listofex}
		...
		\hspace{0.02\linewidth}
		\begin{minipage}[t]{\picwidth}
			\includegraphics[align=t, width=\linewidth]{\picpath/G102M4L7-1}
		\end{minipage}
		\item
		\begin{minipage}[t]{\bodywidth}
