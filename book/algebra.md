...
1. Числовые (арифметические) и буквенные (алгебраические) выражения
...
9.  Общие методы решения неравенств
   7. Разложение на множители и группировка
   8. Метод интервалов
   9.  Замена переменной
   10. Применение свойств функций
   11. Метод рационализации
