...
\begin{enumerate}
	...
	\begin{enumerate}[label=\asbuk*)]
		\begin{minipage}[t]{0.4\textwidth}
			...
			\begin{center}
				\includegraphics[align=t, tmargin=0.5cm, width=0.6\textwidth]{../graphs/graph_2/graph_2}
			\end{center}
		\end{minipage}
		\hspace{0.1\textwidth}
		\begin{minipage}[t]{0.4\textwidth}
			...
			\begin{center}
				\includegraphics[align=t, tmargin=0.5cm, width=0.6\textwidth]{../graphs/graph_3/graph_3}
			\end{center}
		\end{minipage}
	\end{enumerate}
	% #2
	...
	\begin{enumerate}[label=\asbuk*)]
		\begin{minipage}[t]{0.4\textwidth}
			...
			\begin{center}
				\includegraphics[align=t, tmargin=0.5cm, width=0.6\textwidth]{../graphs/graph_4/graph_4}
			\end{center}
		\end{minipage}
		\hspace{0.1\textwidth}
		\begin{minipage}[t]{0.4\textwidth}
			...
			\begin{center}
				\includegraphics[align=t, tmargin=0.5cm ,width=0.6\textwidth]{../graphs/graph_5/graph_5}
		\end{center}
		\end{minipage}
	\end{enumerate}
	% #3
