...
- Перед всеми членами уравнения можно переменить знаки на противоположные. Например:
  
$-8-x^2=-7+2$ равносильно $8+x^2=7-2$

***

5. Уравнения следствия. Посторонние корни.
...
Найдём корни уравнения через дискриминант. Получим, что корнями данного уравнения являются $1$ и $2$. Подставим их в изначальное уравнение и заметим, что корень $2$ является посторонним, так как зануляет знаменатель, а мы знаем, что на ноль делить нельзя.
...
$2x+3=3x-1$
 ...
 Получим, что корнем уравнения является $4$. Попробуем решить исходное уравнение путём переноса обеих частей в одну сторону:

$(2x+3)(x-3)-(3x-1)(x-3)=0$

Вынесем общий множитель $(x-3)$ за скобку:
...
Получается, что корня уравнения всё-таки два: $x=4$ и $x=3$. Следовательно, поделив обе части уравнения на алгебраическое выражение, мы теряем корень. Более детально решения уравнений разных видов мы затронем в одной из следующих глав.
